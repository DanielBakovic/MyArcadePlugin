 ...
 * @package MyArcadePlugin/Core/Admin/Fetch
 */
 ...
 *
 * @param string $key Distributor key.
 */
...
function myarcade_distributors_can_fetch( $distributors = array() ) {
	...
	return array_diff_key( $distributors, array_flip( $distributors_to_remove ) );
}
